<?php
/**
 * #basedon TankAuth Language Strings
 */

// Errors
$lang['users_not_found']                  = 'The following users could not be found: ';
$lang['recipment_list_error']             = 'The list of names you gave does not look valid. Try comma separated list, eg. "user_name, user_name1, user_name2, etc."';
